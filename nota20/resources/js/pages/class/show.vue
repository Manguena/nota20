    ...
    <br/>
      ...
      +"level_id": 6
                ...
                <div class="form-group col-12">
                    ...
                    <inertia-link :href="'/class/subject/'+courseConfigArray['name']+'/'+courseConfigArray['course_id']+'/'+classConfigArray['name']+'/'+classConfigArray['id']+'/'+classConfigArray['level_id']" class="btn btn-primary">
                        Disciplina
                        <font-awesome-icon :icon="['fas', 'list']" size="1x"/>
                    </inertia-link>
                </div>
